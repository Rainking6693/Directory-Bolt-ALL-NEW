...
const CheckoutButton = ({
  ...
  const getButtonStyles = () => {
    ...
    const variants = {
      ...
      secondary: 'border-2 border-brandBlue-500 text-brandBlue-500 bg-transparent hover:bg-brandBlue-500 hover:text-white active:bg-brandBlue-600 active:border-brandBlue-600',
      ...
      ghost: 'text-brandBlue-400 hover:text-brandBlue-300 hover:bg-brandBlue-500/10 active:bg-brandBlue-500/20',
