-- Migration: Find Stale Jobs Function (Fixed - customer_id is TEXT, not UUID)
...
DROP FUNCTION IF EXISTS find_stale_jobs(INTEGER);

-- Create function to find stale jobs with correct types
