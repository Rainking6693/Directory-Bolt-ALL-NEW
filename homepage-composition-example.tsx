// components/NewLandingPage.tsx - Homepage Composition Example
            ...
            <Card variant="artifact" className="border-2 border-volt-200 bg-volt-50">
              <div className="text-center">
                <div className="inline-block mb-2">
                  <span className="bg-volt-500 text-role-text-primary text-xs font-semibold px-3 py-1 rounded-full">
                    Most Popular
                  </span>
                </div>
