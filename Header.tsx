      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-20">
          ...
          <div className="flex items-center">
            <Link
              href="/"
              className="flex items-center space-x-3 text-3xl font-bold text-role-text-primary hover:text-brandBlue-500 transition-colors cursor-pointer"
            >
              <Image src="/logo.jpg" alt="DirectoryBolt Logo" width={64} height={64} className="h-16 w-16 object-contain" priority />
          ...
          <div className="hidden md:flex items-center space-x-8">
            <Link
              href="/analyze"
              className="text-role-text-secondary hover:text-brandBlue-500 transition-colors font-medium p-2 focus:outline-none focus:ring-2 focus:ring-brandBlue-500 focus:ring-offset-2"
            >
              Free Analysis
            </Link>
            <Link
