...
const PricingPreviewSection = dynamic(() => import('./sections/PricingPreviewSection.v2'), { ssr: false })
const TestimonialsSection = dynamic(() => import('./sections/TestimonialsSection.v2'), { ssr: false })
